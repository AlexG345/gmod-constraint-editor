...
include( "constraint_editor/sv_constr_cleanup.lua" )
include( "constraint_editor/sv_constr_data.lua" )
include( "constraint_editor/sv_constr_surface_data.lua" )
...
-- Keys are constraiConstraintEditor.IsConstrLinkedToEnts IDs, values are tables coConstraintEditor.IsConstrLinkedToEntsaining:
...
function ConstraintEditor.AccessConstraint( ply, constrID )
